...
{
    public class CSCustomerMaterialInfoAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSCustomerMaterialInfoPage _pageInstance;

        public CSCustomerMaterialInfoAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSCustomerMaterialInfoPage(_session);
        }
