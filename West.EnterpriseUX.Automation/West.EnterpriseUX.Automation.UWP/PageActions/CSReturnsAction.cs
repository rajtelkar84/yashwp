...
{
    public class CSReturnsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSReturnsPage _pageInstance;

        public CSReturnsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSReturnsPage(_session);
        }
