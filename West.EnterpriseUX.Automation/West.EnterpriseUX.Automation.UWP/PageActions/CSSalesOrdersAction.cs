...
{
    public class CSSalesOrdersAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSSalesOrdersPage _pageInstance;

        public CSSalesOrdersAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSSalesOrdersPage(_session);
        }
