...
{
    public class CSCreditMemoRequestItemsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSCreditMemoRequestItemsPage _pageInstance;

        public CSCreditMemoRequestItemsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSCreditMemoRequestItemsPage(_session);
        }
