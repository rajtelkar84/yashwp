...
{
    public class CSSamplesAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSSamplesPage _pageInstance;

        public CSSamplesAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSSamplesPage(_session);
        }
