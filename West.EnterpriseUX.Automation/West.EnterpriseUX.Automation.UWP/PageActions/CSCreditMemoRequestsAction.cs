...
{
    public class CSCreditMemoRequestsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSCreditMemoRequestsPage _pageInstance;

        public CSCreditMemoRequestsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSCreditMemoRequestsPage(_session);
        }
