...
{
    public class CSDebitMemoRequestsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSDebitMemoRequestsPage _pageInstance;

        public CSDebitMemoRequestsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSDebitMemoRequestsPage(_session);
        }
