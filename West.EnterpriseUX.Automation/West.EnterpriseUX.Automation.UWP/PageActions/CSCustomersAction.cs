...
{
    public class CSCustomersAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSCustomersPage _pageInstance;

        public CSCustomersAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSCustomersPage(_session);
        }
