...
{
    public class CSReturnsItemsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSReturnsItemsPage _pageInstance;

        public CSReturnsItemsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSReturnsItemsPage(_session);
        }
