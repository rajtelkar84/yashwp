...
{
    public class CSSalesOrderItemsAction : BaseAction
    {
        private readonly WindowsDriver<WindowsElement> _session;
        private readonly CSSalesOrderItemsPage _pageInstance;

        public CSSalesOrderItemsAction(WindowsDriver<WindowsElement> session) : base(session)
        {
            this._session = session;
            _pageInstance = new CSSalesOrderItemsPage(_session);
        }
