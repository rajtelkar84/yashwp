...
namespace West.EnterpriseUX.Automation.MobileNew
{
    ...
    public class AppiumSetup
    {
        ...
        public static string EnvName = String.Empty;
        public static string PlatformName = String.Empty;
        public static string laptopName = String.Empty;
        public static string EnvName_PlatformName = String.Empty;
        ...
        private static void LoadEnvironmentVariables()
        {
            ...
            try
            {
               JsonFilePath = projectDirectoryfull + "\\configFiles\\" + "\\Environment_Variables.json";
            }
            catch(Exception ex)
            {
               JsonFilePath = projectDirectoryfull + "/configFiles/" + "/Environment_Variables.json";
            ...
            EnvName = commonEnvironment.EnvName;
            PlatformName = commonEnvironment.DeviceOS;
            laptopName = commonEnvironment.laptopName;
